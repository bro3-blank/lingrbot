...
public class TradeReminderServlet extends HttpServlet {
  ...
  private static final String[] tips = {
    ...
    "ぽちさん武将図鑑によると、UR収集率57％だって・・・この変態(*´д｀*)ｱﾊｧ",
    "4429さんから聞いたけど、スキルレベル8までは生贄R5枚でOKらしい!(´・ω・`)",
    "ごるび～さんから聞いたけど、修練の9チャレでSR生贄はもったいないらしい!(´・ω・`)",
    "4429さんから聞いたけど、合成は10:25までにするといいらしい・・・(´・ω・`)",
    "4429さんから聞いたけど、合成はスコア360万以上はいくらあっても同じだとか・・・(´・ω・`)",
    "たしか4429さんが言ってたけど、レベル10合成はCPよりTPで回数勝負するのがトレンドなんだって・・・(´・ω・`)",
    "4429さんは言いました、「キャンペーン中にCP合成成功率0ですよ！10万TPくらい分成功なし！ｗ」(´・ω・`)",
    ...
    "「ぼくの8->9　180連敗を越えられる奴はいないだろう」 by ギコ軍曹",
